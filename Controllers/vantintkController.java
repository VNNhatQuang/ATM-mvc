...
/**
 * Servlet implementation class vantintkController
 */
@WebServlet("/vantintkController")
public class vantintkController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public vantintkController() {
        super();
